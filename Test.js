import orangehrmData from 'C:\Users\Salma Casasola\Documents\TecnicalTestNI\orangehrm_data.json';
...
it('TC1: Ingresar credenciales incorrectas - Validar que no se pueda acceder al dashboard', () => {
        ...
        // Validamos que aparece el mensaje de error
        cy.get('.oxd-alert-content-text')
          .should('be.visible')
          .and('contain.text', 'Invalid credentials');

        // Validar que la URL sigue siendo la de login (no se realiza ninguna reedireción)
